...
public class NuiteeActivity extends AppCompatActivity {
    ...
    /**
     * Sur le changement de date : mise à jour de l'affichage de la nuitees
     */
    ...
    /**
     * Enregistrement dans la zone de texte et dans la liste de la nouvelle nuitees, à la date choisie
     */
